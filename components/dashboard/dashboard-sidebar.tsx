...
export function DashboardSidebar({ activeTab, onTabChange, className }: DashboardSidebarProps) {
  ...
  const navItems = [
    ...
    {
      id: "debug-availability",
      name: "Verfügbarkeit",
      icon: Activity,
      tab: "debug-availability",
      isAdmin: true,
      href: "/debug/availability",
    },
    {
      id: "debug-deployment",
      name: "Deployment",
      icon: Database,
      tab: "debug-deployment",
      isAdmin: true,
      href: "/debug/deployment",
    },
    {
      id: "debug-missing",
      name: "Fehlende Features",
      icon: FileText,
      tab: "debug-missing",
      isAdmin: true,
      href: "/debug/missing-features",
    },
    {
      id: "debug-mock",
      name: "Mock-Daten",
