...
interface DatumSchrittProps {
  data: ErlebnisData
  updateData: (data: Partial<ErlebnisData>) => void
}

export function DatumSchritt({ data, updateData }: DatumSchrittProps) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h3 className="text-xl font-semibold mb-2">Wann fand dein Erlebnis statt?</h3>
        <p className="text-gray-300 mb-4">
          Wähle das Datum und optional die Uhrzeit, an dem du diese Erfahrung gemacht hast. Falls du dich nicht genau
          erinnerst, wähle ein ungefähres Datum.
        </p>
      </div>
      ...
      <div className="bg-blue-900/30 p-4 rounded-md border border-blue-800/50 mt-6">
        ...
        <p className="text-sm text-gray-300">
          Das Datum und die Uhrzeit helfen uns, zeitliche Muster in ähnlichen Erlebnissen zu erkennen. Wenn du das
