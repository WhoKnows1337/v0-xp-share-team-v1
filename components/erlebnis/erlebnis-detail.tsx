...
export function ErlebnisDetail({ id, erlebnis }: ErlebnisDetailProps) {
  ...
  return (
    <div className="py-6 px-0">
      ...
      {/* Aktionsleiste - jetzt direkt unter dem Bild */}
      <div className="flex justify-between items-center py-4 border-b border-gray-200 dark:border-gray-800 mb-6">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Button variant="ghost" size="icon" className={bookmarked ? "text-yellow-500" : ""} onClick={handleBookmark}>
      ...
      {/* KI-Zusammenfassung - jetzt nach der Aktionsleiste */}
      <div className="mb-6">
        <KIZusammenfassung
            ...
            <Card>
              <CardContent className="pt-6 pb-2">
                ...
                <div className="prose max-w-none dark:prose-invert mb-4">
                  <p>
                    Teile deine Gedanken zu diesem Erlebnis und tausche dich mit anderen Nutzern aus. Kommentare können
                    helfen, neue Perspektiven zu entdecken und tiefere Einsichten zu gewinnen.
                  </p>
                </div>
              </CardContent>
            </Card>
